    ...
    <div className='bg-gray-900 min-h-screen text-white'>
      ...
      <div className='container mx-auto px-4 py-8 mt-20 md:mt-30'>
        <header className='text-center mb-16'>
          <h1 className='text-4xl md:text-5xl font-extrabold text-indigo-300 mb-4'>Cybersecurity</h1>
        ...
        <section>
          <div className='space-y-12'>
            ...
            <div className='space-y-6'>
              <div className='bg-gray-800 p-6 rounded-lg shadow-md'>
                <h2 className='text-2xl font-semibold text-indigo-300 mb-4'>Core Areas of Cybersecurity</h2>
                <div className='space-y-6'>
                  <div className='bg-gray-700 p-4 rounded-lg'>
                    <h3 className='text-xl font-semibold text-indigo-300 mb-2'>Network Security</h3>
                  ...
                  <div className='bg-gray-700 p-4 rounded-lg'>
                    <h3 className='text-xl font-semibold text-indigo-300 mb-2'>Application Security</h3>
                    <ul className='list-disc list-inside text-gray-300'>
                  ...
                  <div className='bg-gray-700 p-4 rounded-lg'>
                    <h3 className='text-xl font-semibold text-indigo-300 mb-2'>Information Security</h3>
                    <ul className='list-disc list-inside text-gray-300'>
                  ...
                  <div className='bg-gray-700 p-4 rounded-lg'>
                    <h3 className='text-xl font-semibold text-indigo-300 mb-2'>Incident Response</h3>
                    <ul className='list-disc list-inside text-gray-300'>
