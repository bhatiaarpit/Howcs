    ...
    <div className='w-3/4 m-16 md:m-auto mt-5'>
      ...
      >
        {Programming_Resource.map(({ Img, CourseName, InstructorName, Btn }, index) => (
          ...
          >
            <div className='navdrop bg-[#865eff] border-[1px] border-white w-[250px] h-[250px] text-black rounded-xl mb-8 md:w-[300px] md:h-[300px] flex flex-col transform transition-transform duration-300 hover:scale-105'>
